...
<body>
    <div class="container">
        <h1>X-Ray Image Preprocessing Pipeline</h1>
        ...
        <div class="details">
            ...
            <ul>
                ...
                <li><strong>Noise Removal:</strong> Gaussian filter with sigma=1.0 to reduce sensor noise</li>
                <li><strong>Contrast Enhancement:</strong> Histogram equalization for better bone visibility</li>
                <li><strong>Resizing:</strong> Bilinear interpolation to 224x224 for ResNet compatibility</li>
    ...
    with open(f'{OUTPUT_DIR}/1_preprocessing_pipeline.html', 'w', encoding='utf-8') as f:
...
<body>
    ...
    with open(f'{OUTPUT_DIR}/2_edge_detection_comparison.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
...
<head>
    ...
    <style>
        ...
        .residual::after { content: 'R'; position: absolute; top: -5px; right: -5px; background: red; color: white; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; font-size: 12px; }
...
<body>
    <div class="container">
        <h1>ResNet50 Model Architecture</h1>
        
        <div class="architecture">
            <div class="layer input">Input<br>224x224x3</div>
            <div class="layer conv residual">Conv2D<br>64 filters<br>3x3</div>
            <div class="layer pool">MaxPool<br>2x2</div>
            <div class="layer conv residual">Conv2D<br>128 filters<br>3x3</div>
            <div class="layer pool">MaxPool<br>2x2</div>
            <div class="layer conv residual">Conv2D<br>256 filters<br>3x3</div>
            <div class="layer conv residual">Conv2D<br>512 filters<br>3x3</div>
            <div class="layer conv residual">Conv2D<br>1024 filters<br>3x3</div>
    ...
    with open(f'{OUTPUT_DIR}/4_model_architecture.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
...
<body>
    <div class="container">
        ...
        <div class="metrics">
            ...
            <div class="metric-card">
                ...
                <div class="metric-label">2x(PrecisionxRecall)/(Precision+Recall)</div>
            </div>
        </div>
    ...
    with open(f'{OUTPUT_DIR}/5_confusion_matrix.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
...
<body>
        ...
        <div class="details">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div>
                    ...
                    <div class="sub-step">Result Storage</div>
    ...
    with open(f'{OUTPUT_DIR}/10_workflow_diagram.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
