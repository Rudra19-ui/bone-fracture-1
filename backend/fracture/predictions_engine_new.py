...
# Categories and mappings - VERIFIED CORRECT
...
def predict_fracture(img, bone_type, force_fresh=False):
    ...
    # CNN MODEL PREDICTION ONLY - NO FALLBACKS
    if HAS_TF:
        try:
            ...
            # Extract probabilities - VERIFIED LABEL MAPPING
            ...
            # CLEAN DECISION RULE - CNN PRIMARY ONLY
            threshold = 0.5
            ...
            return {
                ...
                "disclaimer": "ResNet50 CNN Prediction - Clean Pipeline (No Fallback Overrides)"
            }
...
print("DEBUG: All fallback overrides removed - CNN primary prediction")
print("DEBUG: Label mapping verified: index 0 = fractured, index 1 = normal")
