...
\pgfplotsset{compat=1.18}
    ...
    \fancypagestyle{main}{%
    \fancyhf{}
    \fancyhead[C]{\small \textbf{Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI}}
    ...
    \textbf{ON}\\[1.2em]
    \textbf{\Large “Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI”}\\[2.5em]
    ...
    \begin{justify}
    This is to certify that, the project report entitled \textbf{ “Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI”} 
    ...
    our project titled “Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI”. His insightful suggestions
    ...
    \hspace{12mm}3.1 ResNet50 Backbone and Feature Extraction \dotfill 14 \\
    \hspace{12mm}3.2 Gemini AI Logic Synthesis and Fallback \dotfill 15 \\
    \hspace{12mm}3.3 Backend Orchestration (Django) \dotfill 16 \\
    \hspace{12mm}3.4 Implementation Workflow \dotfill 17 \\

    % ===== CHAPTER 4 =====
    \textbf{4 PERFORMANCE ANALYSIS} \dotfill 20 \\[3pt]
    \hspace{12mm}4.1 Analytical Metrics \dotfill 20 \\
    \hspace{12mm}4.2 System Hardware/Software Requirements \dotfill 22 \\
    \hspace{12mm}4.3 Development and Deployment Tools \dotfill 24 \\
    \hspace{12mm}4.4 Experimental Results and Metrics \dotfill 28 \\

    % ===== CHAPTER 5 =====
    \textbf{5 MATHEMATICAL FOUNDATION} \dotfill 30 \\[3pt]
    
    % ===== CHAPTER 6 =====
    \textbf{6 EXPERIMENTAL RESULTS} \dotfill 33 \\[3pt]

    % ===== CHAPTER 7 =====
    \textbf{7 TECHNICAL IMPLEMENTATION} \dotfill 36 \\[3pt]

    \textbf{CONCLUSION} \dotfill 43\\[3pt]
    \textbf{REFERENCES} \dotfill 45\\[3pt]
    \textbf{APPENDIX} \dotfill 47\\[3pt]
    ...
    4.1 \hspace{5pt} Hardware Requirements for Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI \dotfill 24 \\
    4.2 \hspace{5pt} Software Requirements for Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI \dotfill 26 \\
    ...
    \noindent Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI is an advanced deep learning platform designed to automate the process of bone fracture detection from X-ray imagery. In the current healthcare landscape, radiology departments often face a heavy influx of trauma cases, leading to potential delays. Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI serves as a "first-look" digital assistant that flags abnormal studies and provides visual interpretations to help clinicians prioritize urgent cases.
    ...
    \noindent Trained on expansive datasets like MURA and Kaggle Bone Fracture, the system identifies fractures across various anatomical regions including the Wrist, Elbow, Finger, Forearm, Hand, Humerus, and Shoulder. By providing real-time analysis, confidence scores, and automated reports, Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI aims to reduce diagnostic turnaround time and improve patient outcomes in both emergency and rural clinical settings.

    \section{Problem Statement}
    The diagnosis of bone fractures currently relies on manual X-ray inspection, which faces challenges such as human error due to fatigue, shortage of specialist radiologists in rural areas, and high turnaround times in emergency departments. Fatigue or lack of specialization can lead to misinterpretation of subtle fractures, like hairline fractures. Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI addresses these issues by providing a scalable, AI-driven diagnostic aid that offers consistent, rapid, and objective analysis of medical scans.

    \section{Objectives}
    The main objective of this project is to develop a web-based automated bone fracture detection platform (Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI) that utilizes Vision Transformers and Convolutional Neural Networks to identify fractures with high precision. The specific objectives are as follows:
    \begin{itemize}[leftmargin=1.5cm]
        ...
        \item To utilize Deep Residual Networks (ResNet50) to capture fine-grained spatial features in radiographs.
    ...
    \hline
    Vision Transformers in Medical Imaging, Sharma \& Gupta & 2022 & IEEE & Captured global contextual features using ViT-Base with Patch merging, outperforming standard CNNs. & Direct relevance to the hybrid ViT approach used in Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI. \\
    \hline
    ...
    The proposed system for Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI is organized into sequential modules to ensure accurate and efficient fracture detection from X-ray images.
    ...
    The performance analysis of Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI focuses on evaluating classification accuracy, precision, and recall on the test dataset, as well as system responsiveness during real-time image analysis.

    \section{Algorithm}
    Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI utilizes a \textbf{Hybrid Vision Transformer (ViT)} architecture, which integrates a \textbf{ResNet50 CNN backbone} for spatial feature extraction with a \textbf{Transformer encoder} for global context analysis. This provides a state-of-the-art alternative to traditional pure Convolutional Neural Networks for medical image classification.
    ...
    The proposed Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI system requires modern web browsers and high-performance computing environments for the deep learning models.
    ...
    \end{tabular}
    \caption{Hardware Requirements for Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI}
    \end{table}
    ...
    \end{tabular}
    \caption{Software Requirements for Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI}
    \end{table}
    ...
    The performance of the Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI system was evaluated using standard computer vision metrics. The primary objective was to achieve high accuracy while minimizing false negatives, ensuring that no fractures are missed during clinical triage.

    \textbf{(a) Accuracy and Loss Analysis}
    \begin{itemize}
        \item The ResNet50 model was trained for 25 epochs with early stopping.
        \item \textbf{Training Accuracy:} Reached 95.8\% after convergence.
        \item \textbf{Validation Accuracy:} Stabilized at 92.4\% for fracture detection across all regions.
        \item \textbf{Anatomical Routing Accuracy:} Achieved 99.2\% in distinguishing between Elbow, Hand, and Shoulder.
    ...
    The Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI platform features a modern, medical-grade web dashboard designed for healthcare professionals.
    ...
    \section{Conclusion}
    Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI Phase I has successfully demonstrated that combining modern web technologies with Vision Transformers can create a reliable diagnostic tool for medical imaging. The system effectively classifies common bone fractures—including those in the wrist, elbow, and shoulder—with over 92.4\% accuracy. By automating the triage process and providing standardized medical reports, the platform significantly enhances the clinical workflow and reduces the risk of human oversight in high-pressure environments.

    The modular design, featuring a React.js dashboard and a Django REST API, ensures that the system is scalable and easily integrable into existing hospital infrastructures. Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI bridges the gap between state-of-the-art AI research and practical, user-friendly medical software, providing a robust foundation for automated orthopedic diagnostics.
    ...
    const FractureAnalysis = () => {
        ...
        return (
            <div className="dashboard">
                <h1>Deep Learning for Bone Fracture Detection using ResNet50 and Gemini AI Analysis</h1>
